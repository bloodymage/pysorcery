...
# Sorcecy
SORCERY_APT_PATH = pkg_resources.resource_filename('pysorcery','lib/sorcery/apt/')
SORCERY_SMGL_PATH = pkg_resources.resource_filename('pysorcery','lib/sorcery/smgl/')
